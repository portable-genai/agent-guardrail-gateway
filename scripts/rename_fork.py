#!/usr/bin/env python3
"""Preview or apply a conservative mechanical rename of an agent-guardrail-gateway fork."""
...
_OLD_PACKAGE = "guardrail_gateway"
_OLD_CLI = "guardrail-gateway"
_OLD_ENV_PREFIX = "GUARDRAIL_"
_OLD_RESOURCE = "agent-guardrail-gateway"
_OLD_DIST = "agent-guardrail-gateway"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Rename an agent-guardrail-gateway institutional fork."
    )
